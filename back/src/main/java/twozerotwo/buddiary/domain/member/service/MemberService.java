...
public class MemberService {
	...
	@Transactional
	public MemberDto signUp(MemberSignUpDto userSignUpDto, HttpServletRequest request){
		...
		Member signup = memberDtoFromRequest.signup(userSignUpDto.getUsername(), userSignUpDto.getIntro());
		return signup.toDto();
	}
}

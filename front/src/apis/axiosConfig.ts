...
// const BASE_URL =
//   "http://buddiaryALB-1250245218.ap-northeast-2.elb.amazonaws.com";
const BASE_URL =
  "http://ec2-3-35-197-93.ap-northeast-2.compute.amazonaws.com:8080";
...
const REDIRECT_URI =
  "http://ec2-3-36-102-176.ap-northeast-2.compute.amazonaws.com/login/oauth2/code/kakao";
// const KAKAO_AUTH_URL = `http://localhost:8080/oauth2/authorize/kakao?redirect_uri=${REDIRECT_URI}`;
const KAKAO_AUTH_URL = `http://ec2-3-35-197-93.ap-northeast-2.compute.amazonaws.com:8080/oauth2/authorize/kakao?redirect_uri=${REDIRECT_URI}`;

...
const postDoubleClubApi = (payload: any) => {
  return api.post(`api/clubs/double`, payload,  { withCredentials: true })
  .then((res) => {
      console.log(res)
      return res.data;
    })
...
const getMyClubListApi = (payload: string ) => {
  return api.get(`api/clubs?username=${payload}`, { withCredentials: true })
  .then((res) => {
...
export { postPluralClubApi, postDoubleClubApi, getMyClubListApi, getRecommendBySurveyApi };